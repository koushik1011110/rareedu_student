/*
  ...
  2. Data Updates
    - Set completion status based on existing boolean flags
    - Enable realtime updates for the table

  3. Security
    - Enable realtime publication for student_visa table
*/
...
-- Update existing records to set completion status based on existing boolean flags
UPDATE student_visa
SET 
